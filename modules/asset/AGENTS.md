...
- Offline thumbnail baking is external to the add-on. Asset tools may load supplied previews but must not expose a bake/generation operator. Preview loading skips console window operations in background Blender.
